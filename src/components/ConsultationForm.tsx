      ...
      <div className="bg-gray-50 rounded-lg p-6">
        ...
        <div className="mt-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
            ...
            <label className="flex items-center"><input type="checkbox" name="service_home_medical" checked={formData.service_home_medical} onChange={handleChange} className="mr-2" /><span className="text-gray-700">在宅診療</span></label>
            <label className="flex items-center"><input type="checkbox" name="service_short_stay" checked={formData.service_short_stay} onChange={handleChange} className="mr-2" /><span className="text-gray-700">短期入所施設</span></label>
            <div>
              <label className="flex items-center"><input type="checkbox" name="service_other" checked={formData.service_other} onChange={handleChange} className="mr-2" /><span className="text-gray-700">その他</span></label>
