...
// 型のインポートを追加
import { type UserCareDashboardRow, type SupportCategory, type UpcomingTaskRow, type TeamRecentHistoryRow } from '@/types/support'
import { type Staff } from '@/types/staff'
import CareDashboard from '@/components/support/CareDashboard'
...
interface HomeClientProps {
  ...
  // ★ プロパティ定義を確実に更新
  careDashboardData: UserCareDashboardRow[];
  upcomingTasks: UpcomingTaskRow[]; // ★ 追加
