...
export async function getDashboardData() {
  ...
  try {
    ...
    const [
      ...
      // --- 修正箇所：新設10項目をselectリストに追加 ---
      supabase.from('consultations').select('consultation_date, gender, birth_year, birth_month, birth_day, age_group, consultation_route_self, consultation_route_family, consultation_route_care_manager, consultation_route_elderly_center, consultation_route_disability_center, consultation_route_government, consultation_route_other, consultation_route_government_other, consultation_route_other_text, attribute_elderly, attribute_disability, attribute_poverty, attribute_single_parent, attribute_childcare, attribute_dv, attribute_foreigner, attribute_low_income, attribute_lgbt, attribute_welfare, attribute_rehabilitation_support, attribute_no_guarantor, attribute_disaster_victim_3yr, attribute_major_disaster_victim, attribute_crime_victim, attribute_child_abuse_victim, attribute_newlywed_household, attribute_foster_care_leavers, attribute_uij_turn, attribute_support_worker'),
