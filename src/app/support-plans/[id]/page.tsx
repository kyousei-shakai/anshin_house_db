...
interface SupportPlanDetailPageProps {
  params: Promise<{
    id: string
  }>
}

export default async function SupportPlanDetailPage({ params }: SupportPlanDetailPageProps) {
  ...
  return (
    <Layout>
      <div className="max-w-6xl mx-auto">
        ...
        <SupportPlanDetail supportPlanId={id} />
      </div>
    </Layout>
  )
}